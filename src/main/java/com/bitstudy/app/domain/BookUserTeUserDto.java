...
public class BookUserTeUserDto {
// book
...
// te_info
    ...
    public BookUserTeUserDto() {
    }

    public BookUserTeUserDto(Integer b_no, Integer user_no, Date book_date, Integer tc_no, Integer te_no, String book_etc, String book_state, String tc_name, String tc_call, String te_name, String te_in, String te_out) {
        this.b_no = b_no;
